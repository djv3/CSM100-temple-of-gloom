...
public class TileSelectPanel extends JPanel {
  ...
  private final GUI gui; // Information about the larger GUI
  ...
  public TileSelectPanel(int x, int y, int width, int height, GUI gui) {
    ...
    JLabel instructions = new JLabel("Select a tile for more information.");
  ...
  /**
   * Update the location to (x, y) with size (width, height) of this element (for instance, on
   * screen resize).
   */
  ...
  /**
   * Select node n on the GUI. This displays information on n's panel on the screen to the right.
   */
  ...
  public void paintComponent(Graphics page) {
    ...
    if (selectedNode != null) {
      ...
      page.drawImage(
          pic,
          (int) (IMAGE_X * getWidth()),
          (int) (IMAGE_Y * getHeight()),
      ...
      x =
          getTextXForCenter(
              (Graphics2D) page, text, (int) (ROW_X * getWidth()), (int) (ROW_WIDTH * getWidth()));
      page.drawString(text, x, (int) (ROW_COL_Y * getHeight()));
      text = "Col : " + selectedNode.getTile().getColumn();
      x =
          getTextXForCenter(
              (Graphics2D) page, text, (int) (COL_X * getWidth()), (int) (COL_WIDTH * getWidth()));
      page.drawString(text, x, (int) (ROW_COL_Y * getHeight()));
